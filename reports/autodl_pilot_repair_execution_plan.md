...
- The frozen Prism6 Scaled Jacobian gate is `0.01`; the retained direction-search endpoint has minimum `0.003730823` and 12 below-threshold prisms, all on stable source triangle prefix `9aaa2aed`, layers 49–60, wall fingerprint `8c1b…691b`.
